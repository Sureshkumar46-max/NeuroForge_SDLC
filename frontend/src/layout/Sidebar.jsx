...
const navSections = [
  {
    ...
    items: [
      ...
      { to: '/organizations/create', label: 'Create Organization', icon: PlusCircle },
      { to: '/teams', label: 'Teams', icon: Users },
      { to: '/teams/create', label: 'Create Team', icon: PlusCircle },
      { to: '/members', label: 'Members', icon: UserRound },
      { to: '/members/invite', label: 'Invite Members', icon: UserPlus },
    ],
  },
  {
    label: 'Projects',
